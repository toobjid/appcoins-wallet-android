 ...
 */
package com.asfoundation.wallet.ui.camera;
...
public class CameraSource {
  @SuppressLint("InlinedApi") public static final int CAMERA_FACING_BACK =
      CameraInfo.CAMERA_FACING_BACK;
  @SuppressLint("InlinedApi") public static final int CAMERA_FACING_FRONT =
   ...
   */
  @RequiresPermission(Manifest.permission.CAMERA) public CameraSource start(
      SurfaceHolder surfaceHolder) throws IOException {
    synchronized (mCameraLock) {
      if (mCamera != null) {
        return this;
      }
   ...
   */
  @Nullable @FocusMode public String getFocusMode() {
    return mFocusMode;
  }
   ...
   */
  @Nullable @FlashMode public String getFlashMode() {
    return mFlashMode;
  }
   ...
   * otherwise
   */
  @TargetApi(Build.VERSION_CODES.JELLY_BEAN) public boolean setAutoFocusMoveCallback(
      @Nullable AutoFocusMoveCallback cb) {
  ...
  @StringDef({
      ...
      Camera.Parameters.FOCUS_MODE_EDOF, Camera.Parameters.FOCUS_MODE_FIXED,
   ...
   */
  @TargetApi(Build.VERSION_CODES.JELLY_BEAN) private class CameraAutoFocusMoveCallback
